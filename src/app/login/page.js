...
import { Mail, Lock, AlertCircle, ArrowRight, CheckSquare, Sparkles } from 'lucide-react';
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        const errorData = data || await res.json();
  ...
  return (
    <div className="flex min-h-screen bg-zinc-50 dark:bg-black text-zinc-800 dark:text-zinc-200 transition-colors duration-300">
      ...
      <div className="relative hidden w-1/2 flex-col justify-between bg-zinc-900 p-12 dark:bg-zinc-950 lg:flex border-r border-zinc-200/10 overflow-hidden">
        ...
        <div className="relative z-10 my-auto max-w-lg space-y-6">
          ...
          <p className="text-base leading-relaxed text-zinc-400">
            Log back into your secure control terminal to coordinate pipelines, manage interactive data sets, and update milestone timelines seamlessly.
          </p>
        </div>
      ...
      {/* RIGHT HALF: Interactive Login Form Container */}
